...
class DataConstants {
  ...
  static final List<WorkoutData> workouts = [
    WorkoutData(
        title: TextConstants.gaitTitle,
        exercices: TextConstants.gaitExercises,
        minutes: TextConstants.gaitMinutes,
        currentProgress: 0,
        progress: 0,
        image: PathConstants.gait,
        exerciseDataList: [
          ExerciseData(
            title: TextConstants.gaiting,
